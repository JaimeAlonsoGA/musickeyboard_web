    ...
    return (
        <div className="flex flex-col w-full bg-gray-200 mt-2 py-2">
            <div className="w-full flex flex-col lg:grid-cols-4 xl:grid-cols-5 items-center justify-between">
                {isLgScreen && <Switch text="Show Computer Keys On Note" setter={setKeymapOnKey} state={keymapOnKey} type={1} />}
                <Switch text="Reveal Played Notes and Chords Names" setter={setShowNoteName} state={showNoteName} type={2} />
                {isLgScreen && <Switch text="Keyboard Auto-Scrolling (pressed notes always in view)" setter={setIsAutoScroll} state={isAutoScroll} type={1} />}
                {isLgScreen && <Switch text="Show Key Mapping" setter={setIsKeymapVisible} state={isKeymapVisible} type={2} />}
                <Switch text="Note Name On Every Key" setter={setIsNoteNameVisible} state={isNoteNameVisible} type={1} />
                <Switch text="Keyboard Notation (C/Do)" setter={setNotation} state={notation} type={2} />
                <Switch text="Hide Scrollbar" setter={setScrollbarVisible} state={scrollbarVisible} type={1} />
                <Switch text="Show Keyboard Position" setter={setIsMiniKeyboardVisible} state={isMiniKeyboardVisible} type={2} />
            </div>
