    ...
    return (
        <div className="lg:w-full flex flex-col items-center ">
            <div className="w-full flex-col flex sm:flex-row justify-around">
                {/* {isLgScreen && <Octaver text="Octave Left" side={1} min={2} max={6} setter={setOctaveLeft} setter2={setOctaveRight} state={octaveLeft} middleOctave={setOctaveMiddleLeft} middleOctave2={setOctaveMiddleRight} />} */}
